...
Route::get('/', function () {
    // Load active slides from DB; fall back to hardcoded defaults if table is empty
    $dbSlides = \App\Models\Slider::active()->get();
    ...
    if ($dbSlides->isNotEmpty()) {
        ...
        $slides = [
            [
                ...
                'badge'      => 'Welcome to Dollar Bull University',
            ...
            [
                ...
                'btn1_label' => 'Live Sessions',
                'btn1_url'   => '/live-sessions',
