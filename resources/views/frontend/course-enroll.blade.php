...
<head>
  ...
  <style>
    ...
    * {
    ...
    .face-cap.has-photo .face-preview {
      display: block
    }
...
<body>
  ...
  <div class="wrap">
    <header class="hd">
      ...
      <div class="prices"><span class="new">${{ number_format($course->price, 0) }}</span></div>
    ...
    <div class="grid">
      <div class="panel">
        ...
        <p class="proc">Pay ${{ number_format($course->price, 0) }} in favour of <strong style="color:var(--text)">Trade Campus</strong> and attach payment
          proof. Team contacts you within <strong style="color:var(--gold)">48 hours</strong> via email or WhatsApp.</p>
        <div class="bb">
        ...
        <div class="bb">
          ...
          <div class="br"><span class="lb">TRC20</span><span
              style="font-size:.72rem">TX9cFkKCu3hLfmoLnAkuZtBX5MqHiSb6oh</span></div>
        </div>
        <div class="notice">
      ...
      <div class="panel">
        ...
        <form method="POST" action="{{ route('courses.enroll.store', $course) }}" enctype="multipart/form-data">
          @csrf
          ...
          @include('frontend.partials.enrollment-password')
          ...
          <div class="field">
            ...
            <div class="ph">
              <span class="pfx">+</span>
              <input type="tel" name="whatsapp_number" placeholder="1234567890" value="{{ old('whatsapp_number') }}"
                required>
            </div>
          ...
          <div class="field">
            ...
            <select name="country" required>
              ...
              <option value="Bosnia and Herzegovina" {{ old('country') === 'Bosnia and Herzegovina' ? 'selected' : '' }}>
              ...
              <option value="Czech Republic" {{ old('country') === 'Czech Republic' ? 'selected' : '' }}>Czech Republic
              </option>
              ...
              <option value="Dominican Republic" {{ old('country') === 'Dominican Republic' ? 'selected' : '' }}>Dominican
                Republic</option>
              ...
              <option value="Equatorial Guinea" {{ old('country') === 'Equatorial Guinea' ? 'selected' : '' }}>Equatorial
                Guinea</option>
              ...
              <option value="Guinea-Bissau" {{ old('country') === 'Guinea-Bissau' ? 'selected' : '' }}>Guinea-Bissau
              </option>
              ...
              <option value="Liechtenstein" {{ old('country') === 'Liechtenstein' ? 'selected' : '' }}>Liechtenstein
              </option>
              ...
              <option value="Marshall Islands" {{ old('country') === 'Marshall Islands' ? 'selected' : '' }}>Marshall
                Islands</option>
              ...
              <option value="North Macedonia" {{ old('country') === 'North Macedonia' ? 'selected' : '' }}>North Macedonia
              </option>
              ...
              <option value="Papua New Guinea" {{ old('country') === 'Papua New Guinea' ? 'selected' : '' }}>Papua New
                Guinea</option>
              ...
              <option value="Saint Kitts and Nevis" {{ old('country') === 'Saint Kitts and Nevis' ? 'selected' : '' }}>
              ...
              <option value="Sao Tome and Principe" {{ old('country') === 'Sao Tome and Principe' ? 'selected' : '' }}>Sao
              ...
              <option value="Solomon Islands" {{ old('country') === 'Solomon Islands' ? 'selected' : '' }}>Solomon Islands
              </option>
              ...
              <option value="Trinidad and Tobago" {{ old('country') === 'Trinidad and Tobago' ? 'selected' : '' }}>
              ...
              <option value="United Kingdom" {{ old('country') === 'United Kingdom' ? 'selected' : '' }}>United Kingdom
              </option>
          ...
          <div class="field">
            ...
            <input type="file" name="payment_screenshot" id="paymentFile" style="display:none" accept="image/*"
              required>
          ...
          @if($errors->any())
            <div
              style="background:rgba(192,57,43,.1);border:1px solid rgba(192,57,43,.3);border-left:3px solid var(--red);padding:12px;margin:16px 0;color:#e07b73;font-size:.85rem">
  ...
  <script>
    ...
    function openFaceCam() {
      ...
      if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
        alert('Camera is not supported in this browser. Please use a modern browser or upload from the file picker after allowing access.');
      ...
      navigator.mediaDevices.getUserMedia({ video: { facingMode: 'user', width: { ideal: 1280 }, height: { ideal: 720 } }, audio: false })
        ...
        .catch(function () {
          alert('Could not access the camera (often blocked on plain HTTP). Use “Or upload a clear face photo” below, or open this page over HTTPS.');
        });
    }
    ...
    document.getElementById('btnCamCancel').addEventListener('click', function () {
      closeFaceCam();
    });
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
      ...
      if (!inp.files || !inp.files.length) {
        e.preventDefault();
        alert('Please capture your face photo using the camera area before submitting.');
      }
    });
  </script>
</body>
