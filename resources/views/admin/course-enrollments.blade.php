                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        @if($enrollment->status !== 'verified')
                                            <form method="POST" action="{{ route('course-enrollments.verify', $enrollment) }}" style="display: inline;">
                                                @csrf
                                                @method('PATCH')
                                        ...
                                        @if($enrollment->status !== 'rejected')
                                            <form method="POST" action="{{ route('course-enrollments.reject', $enrollment) }}" style="display: inline;">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class="btn-small btn-reject">Reject</button>
                                            </form>
                                        @endif
                                        <form method="POST" action="{{ route('course-enrollments.destroy', $enrollment) }}" style="display: inline;" onsubmit="return confirm('Delete this enrollment? This cannot be undone.')">
                                            @csrf
                                            @method('DELETE')
...
@push('scripts')
    <script>
        ...
        function openModal(id) {
            ...
            if (st !== 'verified') {
                html += `
                    <form method="POST" action="${adminBase}/course-enrollments/${enrollment.id}/verify" style="display:inline">
            ...
            if (st !== 'rejected') {
                html += `
                    <form method="POST" action="${adminBase}/course-enrollments/${enrollment.id}/reject" style="display:inline">
                        <input type="hidden" name="_token" value="${csrfToken}">
                        <input type="hidden" name="_method" value="PATCH">
                        <button type="submit" class="btn-small btn-reject">Reject</button>
                    </form>`;
