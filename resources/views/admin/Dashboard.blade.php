...
<head>
    ...
    <title>Dashboard — CryptoOnly Admin</title>
...
<aside class="sidebar" id="sidebar" aria-label="Admin Navigation">
    ...
    <nav class="sb-nav" role="navigation">
        ...
        <a href="{{ url('/admin/dashboard') }}" class="sb-item active">
        ...
        <a href="{{ url('/admin/courses') }}" class="sb-item">
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-list">
                        ...
                        <div class="act-item">
                            ...
                            <div>
                                <div class="act-text"><strong>New signal</strong> published — BTC/USDT Long</div>
                        ...
                        <div class="act-item">
                            <span class="act-dot gold"></span>
                            <div>
                                <div class="act-text"><strong>Live session</strong> started — ETH Market Analysis</div>
                        ...
                        <div class="act-item">
                            ...
                            <div>
                                <div class="act-text"><strong>P2P trade</strong> #8934 disputed — review needed</div>
